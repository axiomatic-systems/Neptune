...
const int NPT_ERROR_CONNECTION_REFUSED  = NPT_ERROR_BASE_SOCKET - 1;
const int NPT_ERROR_CONNECTION_FAILED   = NPT_ERROR_BASE_SOCKET - 2;
const int NPT_ERROR_HOST_UNKNOWN        = NPT_ERROR_BASE_SOCKET - 3;
const int NPT_ERROR_SOCKET_FAILED       = NPT_ERROR_BASE_SOCKET - 4;
const int NPT_ERROR_GETSOCKOPT_FAILED   = NPT_ERROR_BASE_SOCKET - 5;
const int NPT_ERROR_BIND_FAILED         = NPT_ERROR_BASE_SOCKET - 6;
const int NPT_ERROR_LISTEN_FAILED       = NPT_ERROR_BASE_SOCKET - 7;
const int NPT_ERROR_ACCEPT_FAILED       = NPT_ERROR_BASE_SOCKET - 8;
const int NPT_ERROR_ADDRESS_IN_USE      = NPT_ERROR_BASE_SOCKET - 9;
const int NPT_ERROR_NETWORK_DOWN        = NPT_ERROR_BASE_SOCKET - 10;
const int NPT_ERROR_NETWORK_UNREACHABLE = NPT_ERROR_BASE_SOCKET - 11;
